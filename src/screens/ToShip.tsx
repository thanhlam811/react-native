...
import { getOrderbyUserIdProcessing,getOrderDetailsByOrderId } from '../api/api'; // chỉnh lại path cho đúng
 ...
 const navigation = useNavigation<any>();
  ...
  const fetchOrders = async () => {
    try {
      ...
      const orderList = await getOrderbyUserIdProcessing(Number(userId));
      setOrders(orderList);
    } catch (error) {
